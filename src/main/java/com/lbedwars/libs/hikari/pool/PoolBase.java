...
import com.lbedwars.libs.hikari.SQLExceptionOverride;
import com.lbedwars.libs.hikari.metrics.IMetricsTracker;
import com.lbedwars.libs.hikari.util.ClockSource;
import com.lbedwars.libs.hikari.util.DriverDataSource;
import com.lbedwars.libs.hikari.util.PropertyElf;
...
abstract class PoolBase {
      ...
      if (this.config.isRegisterMbeans()) {
         try {
            ...
            if ("true".equals(System.getProperty("hikaricp.jmx.register2.0"))) {
               beanConfigName = new ObjectName("com.lbedwars.libs.hikari:type=PoolConfig,name=" + this.poolName);
               beanPoolName = new ObjectName("com.lbedwars.libs.hikari:type=Pool,name=" + this.poolName);
            } else {
               beanConfigName = new ObjectName("com.lbedwars.libs.hikari:type=PoolConfig (" + this.poolName + ")");
               beanPoolName = new ObjectName("com.lbedwars.libs.hikari:type=Pool (" + this.poolName + ")");
            }
   ...
   private void checkValidationSupport(Connection connection) throws SQLException {
      try {
         ...
         this.logger.error("{} - Failed to execute{} connection test query ({}).", this.poolName, this.isUseJdbc4Validation ? " isValid() for connection, configure" : "", ((Throwable)e).getMessage());
         throw e;
      }
   }
   ...
   private void checkDefaultIsolation(Connection connection) throws SQLException {
      try {
         ...
         this.logger.warn((String)"{} - Default transaction isolation level detection failed ({}).", (Object)this.poolName, (Object)e.getMessage());
      ...
      if (this.isQueryTimeoutSupported != 0) {
         try {
            ...
            if (this.isQueryTimeoutSupported == -1) {
               ...
               this.logger.info((String)"{} - Failed to set query timeout for statement. ({})", (Object)this.poolName, (Object)e.getMessage());
            }
         }
      }
      ...
      if (this.isNetworkTimeoutSupported != 0) {
         try {
            ...
            if (this.isNetworkTimeoutSupported == -1) {
               ...
               this.logger.info((String)"{} - Driver does not support get/set network timeout for connections. ({})", (Object)this.poolName, (Object)((Throwable)e).getMessage());
   ...
   private void setLoginTimeout(DataSource dataSource) {
      if (this.connectionTimeout != 2147483647L) {
         try {
            ...
            this.logger.info((String)"{} - Failed to set login timeout for data source. ({})", (Object)this.poolName, (Object)e.getMessage());
         }
      }
   ...
   private static class SynchronousExecutor implements Executor {
      public void execute(Runnable command) {
         try {
            ...
            LoggerFactory.getLogger(PoolBase.class).debug((String)"Failed to execute: {}", (Object)command, (Object)t);
         }
