...
import com.lbedwars.libs.hikari.pool.HikariPool;
...
public class HikariDataSource extends HikariConfig implements DataSource, Closeable {
   ...
   public void evictConnection(Connection connection) {
      HikariPool p;
      if (!this.isClosed() && (p = this.pool) != null && connection.getClass().getName().startsWith("com.lbedwars.libs.hikari")) {
      ...
      if (!this.isShutdown.getAndSet(true)) {
         ...
         if (p != null) {
            try {
               ...
               LOGGER.warn((String)"{} - Interrupted during closing", (Object)this.getPoolName(), (Object)e);
