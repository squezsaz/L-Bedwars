package com.lbedwars.libs.hikari;
...
public class HikariConfig implements HikariConfigMXBean {
   ...
   public void setHealthCheckRegistry(Object healthCheckRegistry) {
      ...
      if (healthCheckRegistry != null) {
         ...
         if (!UtilityElf.safeIsAssignableFrom(healthCheckRegistry, "com.codahale.metrics.health.HealthCheckRegistry")) {
   ...
   private void logConfiguration() {
      ...
      for(String prop : new TreeSet<String>(PropertyElf.getPropertyNames(HikariConfig.class))) {
         try {
   ...
   private String generatePoolName() {
      ...
      try {
         synchronized(System.getProperties()) {
            String next = String.valueOf(Integer.getInteger("com.lbedwars.libs.hikari.pool_number", 0) + 1);
            System.setProperty("com.lbedwars.libs.hikari.pool_number", next);
   ...
   static {
      ...
      SOFT_TIMEOUT_FLOOR = Long.getLong("com.lbedwars.libs.hikari.timeoutMs.floor", 250L);
